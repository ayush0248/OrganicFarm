...
import kisansez from '../../assets/icons/kisansez.png';
import OAI from '../../assets/icons/OAI.png';
import RF from '../../assets/icons/RF.png';
...
const Ecosystem = () => {
  const items = [
    ...
    { icon: kisansez, name: 'Kishan SEZ' },
    { icon: OAI, name: 'Organic Agri Input' },
    { icon: RF, name: 'Rural Finance' },
